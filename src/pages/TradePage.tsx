...
const TradePage = () => {
  ...
  const [altsFilter, setAltsFilter] = useState<string>('all'); // Filter for ALTs tab: 'all', 'usdc', 'bnb', etc.
        ...
        <TabsList className="grid w-full grid-cols-7 mb-6 bg-dex-dark/50 border border-dex-primary/30">
          ...
          <DropdownMenu>
            ...
            >
              ...
              <DropdownMenuRadioGroup value={altsFilter} onValueChange={setAltsFilter}>
                <DropdownMenuRadioItem
                  value="all"
            ...
            <CardContent className="p-0">
              ...
              {sortedByMarketCap
                ...
                .map(token => {
                  ...
                  const showAsPair = altsFilter !== 'all' && altsFilter !== '';
                  const pairSymbol = showAsPair ? altsFilter.toUpperCase() : '';
