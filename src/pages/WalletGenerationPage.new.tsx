...
const WalletGenerationPage: React.FC = () => {
  ...
  const handleGenerateSeedPhrase = () => {
    ...
    const newSeedPhrase = generateMnemonic(strength);
  ...
  // Direct approach to create a new wallet
  const handleCreateNewWallet = () => {
    ...
    try {
      ...
      const newSeedPhrase = generateMnemonic(strength);
      console.log('Seed phrase generated successfully:', newSeedPhrase);
      ...
      setTimeout(() => {
        console.log('Setting current step to GENERATE_SEED with seed phrase:', newSeedPhrase);
