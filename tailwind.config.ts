	...
	theme: {
		...
		extend: {
			colors: {
                ...
                // DEX specific colors - Futuristic dark mode theme with neon accents
                dex: {
                    primary: '#FF00FF',     // Neon pink
                    secondary: '#00FFE0',   // Neon teal/green
                    dark: '#0D0D0D',        // Dark background
                    card: '#1C1C1C',        // Card background
                    light: '#FF8AE2',       // Light pink
                    accent: '#9C4DFF',      // Purple accent
                    ...
                    text: {
                        ...
                        muted: '#666666',    // Placeholder text
                    },
                    blue: '#00BFFF',        // Blue accent
                },
